...
const Product = ({id, discount, img, name, price}) => {
  return (
    <div className="w-[17rem] h-[25rem] flex flex-col space-y-3 rounded-bl-md rounded-br-md m-3">
        <div className="relative bg-midGrey w-full h-[19rem] flex items-center justify-center">
